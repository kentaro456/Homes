...
const Chicken = () => (
  <section id="chicken-section" className="py-20 bg-white text-gray-800">
    <div className="max-w-4xl mx-auto px-4">
      <div className="text-center mb-12">
        <h2 className="font-serif text-4xl md:text-5xl font-bold text-gold mb-2 drop-shadow">Chicken</h2>
        <div className="mx-auto w-24 h-1 bg-gradient-to-r from-gold to-yellow-300 rounded-full mb-4" />
        <p className="text-gray-500 text-lg">Nos incontournables ailes et nuggets de poulet croustillants.</p>
      </div>
